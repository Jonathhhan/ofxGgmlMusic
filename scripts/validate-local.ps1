...
Assert-FileContains (Join-Path $aceStepExampleRoot "src\ofApp.cpp") "(?s)ofSystemLoadDialog.*Choose ACE-Step model folder" "AceStep example model folder browser"
...
Assert-FileContains (Join-Path $aceStepExampleRoot "src\ofApp.cpp") "OFXGGML_ACESTEP_AUTOSTART" "AceStep example auto-start opt out"
...
Assert-FileContains (Join-Path $aceStepExampleRoot "README.md") "AUTOSTART=0" "AceStep example auto-start README"
